...
class DropdownButton(QtWidgets.QWidget):
    def __init__(self, type: str, parent=None):
        ...
        self.edit_option = QtWidgets.QAction(QtGui.QIcon("assets/icons/icon_edit.svg"), "Edit" + " " +type, self)
        self.delete_option = QtWidgets.QAction(QtGui.QIcon("assets/icons/icon_delete.svg"), "Delete"+ " " +type, self)
